...
class InvoiceAppServiceTest {
    ...
    void duplicateFinalizeRejected() {
        cc.openstrata.billing.infrastructure.persistence.InvoiceEntity existing =
            new cc.openstrata.billing.infrastructure.persistence.InvoiceEntity();
        ...
        var ex = org.junit.jupiter.api.Assertions.assertThrows(
            cc.openstrata.billing.domain.DomainException.class,
