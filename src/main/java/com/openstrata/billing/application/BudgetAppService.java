...
import com.openstrata.billing.domain.AlertThreshold;
import com.openstrata.billing.domain.Budget;
...
public class BudgetAppService {
    ...
    public BudgetResponse setBudget(String tenantId, SetBudgetRequest req) {
        if (req.limitCents() <= 0) {
            throw new com.openstrata.billing.domain.DomainException(ErrorCode.BAD_REQUEST,
