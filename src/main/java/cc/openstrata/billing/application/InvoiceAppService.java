...
import cc.openstrata.billing.application.dto.InvoiceLineResponse;
import cc.openstrata.billing.domain.Allocation;
import cc.openstrata.billing.domain.Invoice;
import cc.openstrata.billing.domain.InvoiceLine;
...
import cc.openstrata.billing.infrastructure.persistence.InvoiceEntity;
import cc.openstrata.billing.infrastructure.persistence.InvoiceLineEntity;
import cc.openstrata.billing.infrastructure.persistence.InvoiceLineRepository;
import cc.openstrata.billing.infrastructure.persistence.InvoiceRepository;
...
public class InvoiceAppService {
    ...
    private final cc.openstrata.billing.domain.service.PricingEngine pricingEngine;
    ...
    public InvoiceAppService(UsageRecordRepository usageRecordRepository,
                             ...
                             cc.openstrata.billing.domain.service.PricingEngine pricingEngine,
    ...
    public InvoiceResponse finalize(String tenantId, String period, Map<String, Double> costCenters) {
        if (invoiceRepository.findByTenantId(tenantId).stream()
            ...
            throw new cc.openstrata.billing.domain.DomainException(ErrorCode.INVOICE_ALREADY_FINALIZED,
        ...
        if (costCenters != null && !costCenters.isEmpty()) {
            cc.openstrata.billing.domain.service.ChargebackRule rule =
                new cc.openstrata.billing.domain.service.ChargebackRule();
