...
public class PricingEngine {
    ...
    public long findUnitPrice(UsageDimension dimension) {
        List<cc.openstrata.billing.domain.PriceRule> rules = priceRules.findEffective(dimension);
        if (rules.isEmpty()) {
            throw new cc.openstrata.billing.domain.DomainException(ErrorCode.PRICE_RULE_NOT_FOUND,
