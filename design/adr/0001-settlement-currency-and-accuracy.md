# ADR-0001: Settlement currency and precision
...
Does internal transfer price support multiple currencies? Currently, CNY is deposited in cents (the smallest unit). Cross-border/multi-currency needs to be expanded to `Money`.
